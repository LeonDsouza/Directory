...
public class DirectoryController {
    ...
    public String createFolders() {
        ...
        List studentList = directoryService.createStudentFolder();
        ...
        List facultyList = directoryService.createFacultyFolder();
        ...
        List tpoList = directoryService.createTpoFolder();
        for (Object l1 : tpoList) {
            System.out.println(l1);
            File files = new File(path + "\\" + Integer.toString(year) + "\\TPO\\" + (l1.toString()));
            if (!files.exists()) {
                System.out.println("Something doesnt exist");
                if (files.mkdirs()) {
                    System.out.println("created");
        ...
        List companyList = directoryService.createCompanyFolder();

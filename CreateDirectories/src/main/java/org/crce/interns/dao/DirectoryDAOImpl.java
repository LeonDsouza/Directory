...
public class DirectoryDAOImpl implements DirectoryDAO{
    ...
    @Override
       public List createStudentFolder()
       {
		...
		//Query using Hibernate Query Language
		String SQL_QUERY ="select userName from UserDetails where roleId like '2' or roleId like '1'";
		Query query = session.createQuery(SQL_QUERY);
       ...
       public List createFacultyFolder()
       {
		...
		//Query using Hibernate Query Language
		String SQL_QUERY ="select userName from UserDetails where roleId like '3'";
		Query query = session.createQuery(SQL_QUERY);
       ...
       public List createTpoFolder()
       {
		...
		//Query using Hibernate Query Language
		String SQL_QUERY ="select userName from UserDetails where roleId like '4'";
		Query query = session.createQuery(SQL_QUERY);
